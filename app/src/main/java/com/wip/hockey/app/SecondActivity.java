...
/**
 * Created by DJORDA on 01/06/2017.
 */

public class SecondActivity extends AppCompatActivity {


    private static final String TAG = com.wip.hockey.app.SecondActivity.class.getSimpleName();
    ...
    private void setUpToolbar(){
        ...
        toolbar.setTitle("Guenas !");
        toolbar.setSubtitle("Guenas !");
